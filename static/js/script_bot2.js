...
$(document).ready(function() {
    document.getElementById("chat_content").innerHTML +=
        `<div class="chat-start"> Monday, 1:27 PM </div> <div class="chat-bubble bot">
        Welcome to our site, if you need help simply reply to this message, we are online and ready to help.</div>`
    ...
    $("#user-input-form").on("submit", function(e) {
        ...
        $.ajax({
            ...
            success: function(response_string) {
                ...
                document.getElementById("chat_content").innerHTML +=
                    `<div class="chat-bubble bot">` + response_string.response + `</div>
                    <div class="bot-time">` + time_stamp + `</div>`
...
function endingchat() {
    ...
    // $('.chat-header').toggleClass('hide');
    $(".chat-bot-icon").click()
    var time_stamp = time_date()
    document.getElementById("chat_content").innerHTML =
        `<div class="chat-start">` + time_stamp + `</div> <div class="chat-bubble bot">
    Welcome to our site, if you need help simply reply to this message, we are online and ready to help.</div>`
